...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS('Users created: {}'.format(User.objects.count())))
        self.stdout.write(self.style.SUCCESS('Teams created: {}'.format(Team.objects.count())))
        self.stdout.write(self.style.SUCCESS('Activities created: {}'.format(Activity.objects.count())))
        self.stdout.write(self.style.SUCCESS('Leaderboard entries created: {}'.format(Leaderboard.objects.count())))
        self.stdout.write(self.style.SUCCESS('Workouts created: {}'.format(Workout.objects.count())))
